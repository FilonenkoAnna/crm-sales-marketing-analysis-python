[README.md](https://github.com/user-attachments/files/30979010/README.md)
...
The project combines data cleaning, exploratory analysis, sales and marketing analytics, product performance, unit economics, and experiment design.
...
The processed data is then used by the analytical notebooks.
...
This project was developed as part of Data Analytics training and demonstrates practical work with CRM data, Python analytics, business metrics, unit economics, and experiment design.
